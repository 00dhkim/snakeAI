...
# file create test
agent.model.save_weights("./snake_dqn_0.h5")
...
for e in range(EPISODES):
    ...
    #     logging.info(f'model 1 saved at {e}')
    #     save_flag_1 = False
